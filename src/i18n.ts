...
const T: Record<Locale, Dict> = {
  en: {
    ...
    // System
    sys_temps: "Temperatures", sys_fan: "Fan",
    sys_res: "Resources",
    sys_ram: "Enabled RAM",
  ...
  fr: {
    ...
    sys_temps: "Températures", sys_fan: "Ventilateur", sys_status: "Statut", sys_scheduler: "Scheduler",
  ...
  de: {
    ...
    sys_temps: "Temperaturen", sys_fan: "Lüfter", sys_status: "Status", sys_scheduler: "Scheduler",
  ...
  es: {
    ...
    sys_temps: "Temperaturas", sys_fan: "Ventilador", sys_status: "Estado", sys_scheduler: "Planificador",
  ...
  it: {
    ...
    sys_temps: "Temperature", sys_fan: "Ventola", sys_status: "Stato", sys_scheduler: "Scheduler",
  ...
  pt: {
    ...
    sys_temps: "Temperaturas", sys_fan: "Ventoinha", sys_status: "Estado", sys_scheduler: "Scheduler",
  ...
  nl: {
    ...
    sys_temps: "Temperaturen", sys_fan: "Ventilator", sys_status: "Status", sys_scheduler: "Planner",
  ...
  pl: {
    ...
    sys_temps: "Temperatury", sys_fan: "Wentylator", sys_status: "Status", sys_scheduler: "Harmonogram",
  ...
  ru: {
    ...
    sys_temps: "Температуры", sys_fan: "Вентилятор", sys_status: "Состояние", sys_scheduler: "Планировщик",
