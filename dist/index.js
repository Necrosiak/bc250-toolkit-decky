...
// THIS FILE IS AUTO GENERATED
function BsThermometerHalf (props) {
  return GenIcon({"attr":{"fill":"currentColor","viewBox":"0 0 16 16"},"child":[{"tag":"path","attr":{"d":"M9.5 12.5a1.5 1.5 0 1 1-2-1.415V6.5a.5.5 0 0 1 1 0v4.585a1.5 1.5 0 0 1 1 1.415"},"child":[]},{"tag":"path","attr":{"d":"M5.5 2.5a2.5 2.5 0 0 1 5 0v7.55a3.5 3.5 0 1 1-5 0zM8 1a1.5 1.5 0 0 0-1.5 1.5v7.987l-.167.15a2.5 2.5 0 1 0 3.333 0l-.166-.15V2.5A1.5 1.5 0 0 0 8 1"},"child":[]}]})(props);
}function BsLightningCharge (props) {
  return GenIcon({"attr":{"fill":"currentColor","viewBox":"0 0 16 16"},"child":[{"tag":"path","attr":{"d":"M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09zM4.157 8.5H7a.5.5 0 0 1 .478.647L6.11 13.59l5.732-6.09H9a.5.5 0 0 1-.478-.647L9.89 2.41z"},"child":[]}]})(props);
}function BsGithub (props) {
  return GenIcon({"attr":{"fill":"currentColor","viewBox":"0 0 16 16"},"child":[{"tag":"path","attr":{"d":"M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"},"child":[]}]})(props);
...
const mk = (C) => (p = {}) => (SP_JSX.jsx(C, { size: p.size, color: p.color, style: { verticalAlign: "-0.125em", flexShrink: 0, ...(p.style || {}) } }));
const IcController = mk(BsController);
const IcDownload = mk(BsCloudDownload);
const IcGear = mk(BsGearFill);
const IcGithub = mk(BsGithub);
const IcLightning = mk(BsLightningCharge);
const IcRefresh = mk(BsArrowRepeat);
const IcThermometer = mk(BsThermometerHalf);
const IcWarn = mk(BsExclamationTriangleFill);
...
function CpuUnlockSection() {
    ...
    const setBoot = async (on) => {
        setBusy(true);
        setMsg(null);
        try {
            const r = await call("set_cpu_unlock_boot", on);
            if (!r.ok)
...
function SystemTab() {
    ...
    const loadColor = (v) => v == null ? "#888" : v > 90 ? "#f44336" : v > 70 ? "#ff9800" : "#4caf50";
    ...
    return (SP_JSX.jsxs(SP_JSX.Fragment, { children: [SP_JSX.jsxs(DFL.PanelSection, { title: t("sys_temps"), children: [SP_JSX.jsx(InfoRow, { label: "CPU", children: SP_JSX.jsxs("span", { style: { fontWeight: "bold" }, children: [SP_JSX.jsx("span", { style: { color: tempColor(status.cpu_temp) }, children: status.cpu_temp != null ? `${status.cpu_temp}°C` : t("cu_na") }), status.cpu_clock_mhz != null &&
                                ...
                                SP_JSX.jsx("span", { style: { color: "#666", fontSize: 10 }, children: `  ·  ${t("sys_gpu_load_note")}` })] }), SP_JSX.jsx(InfoRow, { label: t("sys_fan"), children: SP_JSX.jsx("span", { style: { color: status.fan_rpm ? "#67a3ff" : "#888", fontWeight: "bold" }, children: status.fan_rpm != null ? `${status.fan_rpm} RPM` : t("cu_na") }) })] }), SP_JSX.jsxs(DFL.PanelSection, { title: t("sys_res"), children: [SP_JSX.jsx(InfoRow, { label: t("sys_ram"), children: SP_JSX.jsx("span", { style: { color: "#67a3ff", fontWeight: "bold" }, children: status.mem_total_mb != null ? gb(status.mem_total_mb) : t("cu_na") }) }), SP_JSX.jsx(InfoRow, { label: t("sys_ram_used"), children: SP_JSX.jsx("span", { style: { color: ramColor, fontWeight: "bold" }, children: status.mem_used_mb != null
